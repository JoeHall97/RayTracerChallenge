...
public class RingPatternUnitTests
{
    ...
    public void TestRingPattern()
    {
        ...
        pattern.PatternAt(Vec4.Point(1, 0, 0)).ShouldBe(Colour.Black);
        pattern.PatternAt(Vec4.Point(0, 0, 1)).ShouldBe(Colour.Black);
        pattern.PatternAt(Vec4.Point(0.708d, 0, 0.708d)).ShouldBe(Colour.Black);
    }
}