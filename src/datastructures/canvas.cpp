...
/// the number does not cause the current line to exceed 70 characters in length.
/// If the number would exceed the 70 character length, then a new line is output
/// and the row length is reset.
