...
rtc::CoordTuple Matrix::operator*(const rtc::CoordTuple &rhs) const {
    ...
    return rtc::CoordTuple{
            rhs.x * matrix_[0][0] + rhs.y * matrix_[0][1] + rhs.z * matrix_[0][2] + rhs.w * matrix_[0][3],
            rhs.x * matrix_[1][0] + rhs.y * matrix_[1][1] + rhs.z * matrix_[1][2] + rhs.w * matrix_[1][3],
            rhs.x * matrix_[2][0] + rhs.y * matrix_[2][1] + rhs.z * matrix_[2][2] + rhs.w * matrix_[2][3],
            rhs.x * matrix_[3][0] + rhs.y * matrix_[3][1] + rhs.z * matrix_[3][2] + rhs.w * matrix_[3][3]};
}
