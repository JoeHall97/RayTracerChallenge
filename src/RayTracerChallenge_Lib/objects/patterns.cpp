...
rtc::Pattern::patternAtObject(const Object *shape,
                              const Vec4 &worldPoint) const noexcept {
  // we use the inverse of these matrices because they transform
  // object->world, but we need to go from world->object.
